...
import mams.model.student.MatID;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, "1"
                + CommandTestUtil.INVALID_EMAIL_DESC, MatID.MESSAGE_CONSTRAINTS); // invalid email
        CommandParserTestUtil.assertParseFailure(parser, "1"
        ...
        CommandParserTestUtil.assertParseFailure(parser, "1"
                + CommandTestUtil.INVALID_PHONE_DESC + CommandTestUtil.MATID_DESC_AMY, Phone.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased()
                ...
                + CommandTestUtil.MATID_DESC_AMY + CommandTestUtil.ADDRESS_DESC_AMY
        ...
        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withName(CommandTestUtil.VALID_NAME_AMY)
                .withPhone(CommandTestUtil.VALID_PHONE_BOB).withMatID(CommandTestUtil.MATID_DESC_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + CommandTestUtil.PHONE_DESC_BOB
                + CommandTestUtil.MATID_DESC_AMY;

        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder()
                .withPhone(CommandTestUtil.VALID_PHONE_BOB)
                .withMatID(CommandTestUtil.VALID_MATID_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // email
        userInput = targetIndex.getOneBased() + CommandTestUtil.MATID_DESC_AMY;
        descriptor = new EditStudentDescriptorBuilder().withMatID(CommandTestUtil.VALID_MATID_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        CommandParserTestUtil.assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_STUDENT;
        String userInput = targetIndex.getOneBased()
                + CommandTestUtil.PHONE_DESC_AMY + CommandTestUtil.ADDRESS_DESC_AMY + CommandTestUtil.MATID_DESC_AMY
                + CommandTestUtil.TAG_DESC_FRIEND + CommandTestUtil.PHONE_DESC_AMY + CommandTestUtil.ADDRESS_DESC_AMY
                + CommandTestUtil.MATID_DESC_AMY + CommandTestUtil.TAG_DESC_FRIEND
                + CommandTestUtil.PHONE_DESC_BOB + CommandTestUtil.ADDRESS_DESC_BOB
                + CommandTestUtil.MATID_DESC_BOB + CommandTestUtil.TAG_DESC_HUSBAND;

        EditCommand.EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder()
                .withPhone(CommandTestUtil.VALID_PHONE_BOB)
                .withMatID(CommandTestUtil.VALID_MATID_BOB).withAddress(CommandTestUtil.VALID_ADDRESS_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + CommandTestUtil.MATID_DESC_BOB
        ...
        descriptor = new EditStudentDescriptorBuilder().withPhone(CommandTestUtil.VALID_PHONE_BOB)
                .withMatID(CommandTestUtil.VALID_MATID_BOB)
