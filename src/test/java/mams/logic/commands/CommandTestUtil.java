...
public class CommandTestUtil {
    ...
    public static final String VALID_PREVMODS_AMY = "CS2010, CS3920";
    public static final String VALID_PREVMODS_BOB = "CS2010, CS1220";
    ...
    public static final String INVALID_PREVMODS_DESC = " " + PREFIX_PREVMODS + "ありがと"; // not alphanumeric
